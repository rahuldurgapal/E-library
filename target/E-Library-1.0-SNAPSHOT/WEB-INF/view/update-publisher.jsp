    ...
    <div class="container">
        ...
        <div class="row">
            <div class="offset-md-3 col-md-6">
                <form class="yourform" action="${pageContext.request.contextPath}/save-publisher" method="post" autocomplete="off">
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="id" value="${pub.id}" required>
                    </div>
                    <div class="form-group">
                        <label>Publisher Name</label>
                        <input type="text" class="form-control"  name="name" value="${pub.name}" required>
                    </div>
